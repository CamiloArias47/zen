...
class CardTypeGame extends React.Component {
    render() {
        ...
        return (
            <a onClick={clickFunction} href="#solo" data-type={type}>
                <div className="card" data-type={type}>
                    <div className="card-image" data-type={type}>
                        <img src={`/${bgImg}`} data-type={type} alt="Modo de juego"/>
                    </div>
    ...
    render() {
        return (
            <div className="row">
                ...
                <div className="col s12 m6">
                     <CardTypeGame clickFunction={this.props.funcTypeGame} bgImg={imgBg} title="multi jugador" type="multiplayer"/>
                </div>
            </div>
        )
    }
